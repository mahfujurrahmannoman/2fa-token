...
import { CameraIcon, ClipboardCheckIcon, ClipboardIcon, ClipboardPasteIcon } from './icons';
    ...
    return (
        <div className="w-full max-w-md mx-auto bg-slate-800 rounded-2xl shadow-2xl p-6 md:p-8 space-y-8 transform transition-all duration-300">
            ...
            <header className="text-center">
                ...
                <p className="text-slate-400 mt-2">Generate 2FA tokens instantly in your browser</p>
            </header>
            ...
            <section>
                ...
                {error && <p className="text-red-400 text-center mt-4 text-sm" role="alert">{error}</p>}
